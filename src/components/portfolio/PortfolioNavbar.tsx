...
function NavbarPortfolio() {
	...
	return (
		<header className='w-full bg-transparent fixed top-0 left-0 backdrop-blur-2xl shadow-md z-50 md:px-8'>
			{/* Desktop Navbar */}
			...
			{/* Mobile Menu */}
			{isOpen && (
				<div className='lg:hidden transition-all duration-300 shadow-2xl border-b border-gray-700 rounded-b-md px-6 py-4 flex flex-col gap-4 justify-center items-center'>
					{links.map((link) => (
						<a
							key={link}
							href={`#${link.toLowerCase()}`}
