...
function PortfolioProjects() {
	...
	const projects = [
		{
			title: "Concept_clarity",
			description:
				"Concept_Clarity is an AI-powered learning assistant designed to help users understand complex scientific and technical concepts in a simple and interactive way.",
			image: "https://media.licdn.com/dms/image/v2/D5612AQFVeMkGVJ-7KQ/article-cover_image-shrink_600_2000/article-cover_image-shrink_600_2000/0/1675947512127?e=2147483647&v=beta&t=rjiyoo2SlKwEx7vhVPZm1AGIl-uXEFwoKXQ_ZLGV3Aw",
		...
		},
		{
			...
			description:
			"Deepfake technology uses advanced deep learning techniques to create highly realistic fake images and videos by replacing or altering a person’s face.",			
			image: "https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_750,h_394/https://authbridge.com/wp-content/uploads/2025/06/Best-Software-for-Deepfake-scam-detection-blog-image-1024x538.png",
			tags: ["Open CV", "Python", "Tensorflow", "Keras"],
			featured: true,
