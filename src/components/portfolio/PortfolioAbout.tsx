...
function PortfolioAbout() {
	...
	const experiences = [
		...
		
		{
			...
			company: "PSIT Kanpur",
			description:
				"Completed a Bachelor's degree in Computer Engineering, which provided a solid academic foundation in logical reasoning, analytical thinking, and core programming principles.",
		},
	];
